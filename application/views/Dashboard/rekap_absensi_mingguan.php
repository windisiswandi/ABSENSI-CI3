...
<form method="post" action="<?= base_url("absensi/download_absensi_mingguan") ?>" class="form"> 
    <h3 class="mb-5">REKAP ABSENSI SISWA - PER MINGGU</h3>
    ...
    <div class="row mt-3"> 
        <div class="row">
            <div class="mb-3 row">
                <div class="col-sm-3">
                    <input type="week" name="calender" class="form-control">
                </div>
            </div>
        </div>
